...
const PROJECTS = [
  {
    ...
    tools: ['SQL', 'TypeScript', 'Data Transformation', 'Data Modeling'],
  },
  {
    ...
    tools: ['Python', 'R', 'EDA', 'Predictive Modeling'],
  },
  {
    image: bannerRetail,
    tag: 'Retail',
    ...
    tools: ['SQL', 'Excel', 'Power Query', 'Power BI', 'Dashboard Development'],
  },
  {
    image: bannerBanking,
    tag: 'Banking & Finance',
    ...
    tools: ['SQL', 'Tableau', 'Dashboard Development', 'A/B Testing', 'Statistics'],
  },
  {
    image: bannerHR,
    ...
    tools: ['Python', 'Power Query', 'Power BI', 'Data Modeling', 'Logistic Regression'],
  },
  {
