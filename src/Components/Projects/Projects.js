...
const PROJECTS = [
  {
    ...
    approach: 'Built a custom SQL parser to transform the raw dump into structured inventory, sales, and balance datasets, then built dashboards for stock and sales tracking.',
